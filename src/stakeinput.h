...
#ifndef LYNTHEX_STAKEINPUT_H
#define LYNTHEX_STAKEINPUT_H
...
public:
    ...
    virtual bool IsZXLYN() const = 0;
    virtual CDataStream GetUniqueness() const = 0;
    virtual bool ContextCheck(int nHeight, uint32_t nTime) = 0;
};


class CXlynStake : public CStakeInput
{
private:
...
public:
    ...
    bool IsZXLYN() const override { return false; }
    bool ContextCheck(int nHeight, uint32_t nTime) override;
};


#endif //LYNTHEX_STAKEINPUT_H
