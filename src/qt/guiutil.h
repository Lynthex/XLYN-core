...
/** Utility functions used by the LYNTHEX Qt UI.
 */
namespace GUIUtil
{
...
// Render XLYN addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZxlyn = false);
...
// Parse "lynthex:" URI into recipient object, return true on successful parsing
