...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            LYNTHEXGUI* window = static_cast<LYNTHEXGUI*>(parentWidget());
...
{
    LYNTHEXGUI* gui = static_cast<LYNTHEXGUI*>(parentWidget());
...
{
    hide();
    static_cast<LYNTHEXGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("LYNTHEX will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your XLYNs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
