...
/* LYNTHEX GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "LYNTHEX"
#define QAPP_ORG_DOMAIN "lynthex.org"
#define QAPP_APP_NAME_DEFAULT "LYNTHEX-Qt"
#define QAPP_APP_NAME_TESTNET "LYNTHEX-Qt-testnet"
