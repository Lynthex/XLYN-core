...
#include "qt/lynthex/forms/ui_receivewidget.h"
#include "qt/lynthex/requestdialog.h"
...
#include "qt/lynthex/addressholder.h"
...
ReceiveWidget::ReceiveWidget(LYNTHEXGUI* parent) :
    PWidget(parent),
