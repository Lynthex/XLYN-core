...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, LYNTHEXGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, LYNTHEXGUI* gui, double posX = 3);
