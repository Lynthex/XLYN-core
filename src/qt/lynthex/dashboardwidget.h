...
#include "qt/lynthex/furabstractlistitemdelegate.h"
#include "qt/lynthex/furlistrow.h"
#include "transactiontablemodel.h"
#include "qt/lynthex/txviewholder.h"
...
#include "config/lynthex-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    explicit DashboardWidget(LYNTHEXGUI* _window);
    ~DashboardWidget();
