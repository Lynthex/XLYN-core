...
#include "qt/lynthex/sendcustomfeedialog.h"
#include "qt/lynthex/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(LYNTHEXGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &LYNTHEXGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
