...
#include "qt/lynthex/settings/settingsnetworkwidget.h"
#include "qt/lynthex/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/lynthex/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(LYNTHEXGUI* _window, QWidget *parent) :
