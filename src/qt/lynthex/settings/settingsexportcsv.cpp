...
#include "qt/lynthex/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(LYNTHEXGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("LYNTHEX_tx_csv_export(*.csv)") : tr("LYNTHEX_addresses_csv_export(*.csv)"),
                                        nullptr);
