...
#include "qt/lynthex/settings/forms/ui_settingsmainoptionswidget.h"
#include "QListView"
...
SettingsMainOptionsWidget::SettingsMainOptionsWidget(LYNTHEXGUI* _window, QWidget *parent) :
    ...
    ui(new Ui::SettingsMainOptionsWidget)
{
    ...
    // Switch
    ui->pushSwitchStart->setText(tr("Start XLYN on system login"));
