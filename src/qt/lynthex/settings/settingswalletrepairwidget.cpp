...
#include "qt/lynthex/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/lynthex/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(LYNTHEXGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to LYNTHEXGUI::handleRestart()
