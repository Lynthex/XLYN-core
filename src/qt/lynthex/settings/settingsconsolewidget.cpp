...
#include "qt/lynthex/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/lynthex/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(LYNTHEXGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
    ...
    messageInternal(CMD_REPLY, (tr("Welcome to the XLYN RPC console.") + "<br>" +
