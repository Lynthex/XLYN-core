...
#include "qt/lynthex/settings/forms/ui_settingswidget.h"
...
SettingsWidget::SettingsWidget(LYNTHEXGUI* parent) :
    PWidget(parent),
    ui(new Ui::SettingsWidget)
{
    ...
    connect(ui->pushButtonHelp1, &QPushButton::clicked, window, &LYNTHEXGUI::openFAQ);
