...
#include "qt/lynthex/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/lynthex/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(LYNTHEXGUI* _window, QWidget *parent) :
