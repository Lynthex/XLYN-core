...
#include "qt/lynthex/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/lynthex/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(LYNTHEXGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
           ...
           ui->labelNumber_UnspendableXLYN,
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableXLYN,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableXLYN,
    ...
    connect(ui->pushButton_UnspendableXLYN, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableXLYN);});
    ...
    if (parent)
        connect(parent, &LYNTHEXGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
