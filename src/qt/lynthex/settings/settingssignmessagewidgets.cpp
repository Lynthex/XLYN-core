...
#include "qt/lynthex/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(LYNTHEXGUI* _window, QWidget *parent) :
