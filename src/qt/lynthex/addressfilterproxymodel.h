...
#ifndef LYNTHEX_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define LYNTHEX_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //LYNTHEX_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
