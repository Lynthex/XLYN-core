...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(XLYN);
    unitlist.append(mXLYN);
    unitlist.append(uXLYN);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    ...
    case XLYN:
        return QString("XLYN");
    case mXLYN:
        return QString("mXLYN");
    case uXLYN:
        return QString::fromUtf8("uXLYN");
    default:
        return QString("???");
    }
}

QString BitcoinUnits::name(int unit, bool isZxlyn)
{
...
QString BitcoinUnits::floorWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZXLYN)
{
    QSettings settings;
    ...
    return result + QString(" ") + name(unit, isZXLYN);
}

QString BitcoinUnits::floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZXLYN)
{
    QString str(floorWithUnit(unit, amount, plussign, separators, cleanRemainderZeros, isZXLYN));
    str.replace(QChar(THIN_SP_CP), QString(COMMA_HTML));
    return QString("<span style='white-space: nowrap;'>%1</span>").arg(str);
}
