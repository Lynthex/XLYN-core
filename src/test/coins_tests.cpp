    ...
    for (unsigned int i = 0; i < NUM_SIMULATION_ITERATIONS; i++) {
        ...
        if (randiter % 20 < 19) {
            ...
            if (randiter % 20 < 2 || coinbase_coins.size() < 10) {
                // XLYN: don't test for duplicate coinbases as those are not possible due to
...
BOOST_AUTO_TEST_CASE(ccoins_add)
{
     ...
     *
     * LYNTHEX: Remove Coinbase argument (ref: https://github.com/LYNTHEX-Project/LYNTHEX/pull/1775)
     *
