...
UniValue stop(const JSONRPCRequest& jsonRequest)
{
    ...
    StartShutdown();
    return "LYNTHEX server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* XLYN features */
        {"lynthex", "listmasternodes", &listmasternodes, true },
        {"lynthex", "getmasternodecount", &getmasternodecount, true },
        {"lynthex", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"lynthex", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"lynthex", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"lynthex", "masternodecurrent", &masternodecurrent, true },
        {"lynthex", "startmasternode", &startmasternode, true },
        {"lynthex", "createmasternodekey", &createmasternodekey, true },
        {"lynthex", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"lynthex", "listmasternodeconf", &listmasternodeconf, true },
        {"lynthex", "getmasternodestatus", &getmasternodestatus, true },
        {"lynthex", "getmasternodewinners", &getmasternodewinners, true },
        {"lynthex", "getmasternodescores", &getmasternodescores, true },
        {"lynthex", "preparebudget", &preparebudget, true },
        {"lynthex", "submitbudget", &submitbudget, true },
        {"lynthex", "mnbudgetvote", &mnbudgetvote, true },
        {"lynthex", "getbudgetvotes", &getbudgetvotes, true },
        {"lynthex", "getnextsuperblock", &getnextsuperblock, true },
        {"lynthex", "getbudgetprojection", &getbudgetprojection, true },
        {"lynthex", "getbudgetinfo", &getbudgetinfo, true },
        {"lynthex", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"lynthex", "mnfinalbudget", &mnfinalbudget, true },
        {"lynthex", "checkbudgets", &checkbudgets, true },
        {"lynthex", "mnsync", &mnsync, true },
        {"lynthex", "spork", &spork, true },
        ...
        {"zerocoin", "getzxlynseed", &getzxlynseed, false },
        {"zerocoin", "setzxlynseed", &setzxlynseed, false },
        {"zerocoin", "generatemintlist", &generatemintlist, false },
        {"zerocoin", "searchdzxlyn", &searchdzxlyn, false },
        {"zerocoin", "dzxlynstate", &dzxlynstate, false },
...
{
    return "> lynthex-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:18222/\n";
}
