...
extern UniValue setzxlynseed(const JSONRPCRequest& request);
extern UniValue getzxlynseed(const JSONRPCRequest& request);
extern UniValue generatemintlist(const JSONRPCRequest& request);
extern UniValue searchdzxlyn(const JSONRPCRequest& request);
extern UniValue dzxlynstate(const JSONRPCRequest& request);
