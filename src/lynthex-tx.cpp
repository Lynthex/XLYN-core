...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("LYNTHEX lynthex-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  lynthex-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded lynthex transaction") + "\n" +
                               "  lynthex-tx [options] -create [commands]   " + _("Create hex-encoded lynthex transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded lynthex transaction
