...
#ifndef LYNTHEX_ZXLYNWALLET_H
#define LYNTHEX_ZXLYNWALLET_H
...
public:
    ...
    void GenerateDeterministicZXLYN(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZXLYN(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
