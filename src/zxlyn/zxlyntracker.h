...
#ifndef LYNTHEX_ZXLYNTRACKER_H
#define LYNTHEX_ZXLYNTRACKER_H
...
public:
    CzXLYNTracker(CWallet* parent);
    ~CzXLYNTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzXLYNWallet* zXLYNWallet = NULL);
