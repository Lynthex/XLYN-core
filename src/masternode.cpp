...
{
    if (nHeight >  1400000) return 2000 * COIN;
    if (nHeight >  1100000) return 2000 * COIN;
    if (nHeight >  800000) return 2000 * COIN;
    if (nHeight >  500000) return 2000 * COIN;
    if (nHeight >  200000) return 2000 * COIN;
    if (nHeight >   50000) return 2000 * COIN;
    if (nHeight >   30000) return 2000 * COIN;
    if (nHeight >   10000) return 2000 * COIN;
...
{
    if (nHeight > 9500000)	return 1.00 * COIN;
    if (nHeight > 5000000)	return 1.30 * COIN;
    if (nHeight > 500000)	return 7.00 * COIN;
    if (nHeight > 475000)	return 6.70 * COIN;
	if (nHeight > 450000)	return 6.40 * COIN;
    if (nHeight > 425000)	return 6.10 * COIN;
    if (nHeight > 400000)	return 5.80 * COIN;
    if (nHeight > 375000)	return 5.50 * COIN;
    if (nHeight > 350000)	return 5.20 * COIN;
    if (nHeight > 325000)	return 4.90 * COIN;
    if (nHeight > 300000)	return 4.60 * COIN;
    if (nHeight > 275000)	return 4.30 * COIN;
    if (nHeight > 250000)	return 4.00 * COIN;
    if (nHeight > 225000)	return 3.70 * COIN;
    if (nHeight > 200000)	return 3.40 * COIN;
    if (nHeight > 175000)	return 3.10 * COIN;
    if (nHeight > 150000)	return 2.80 * COIN;
    if (nHeight > 125000)	return 2.50 * COIN;
    if (nHeight > 100000)	return 2.20 * COIN;
    if (nHeight > 75000)	return 1.90 * COIN;
    if (nHeight > 50000)	return 1.60 * COIN;
    if (nHeight > 20000)	return 1.30 * COIN;
    if (nHeight > 300)		return 1.00 * COIN;
    if (nHeight > 1)		return 5.00 * COIN;   // POW BLOCK REWARD   
    if (nHeight >       0) return 200000 * COIN;         // ZERO PREMINES
...
{
    if (nHeight > 9500000)	return 0.950 * COIN;
    if (nHeight > 5000000)	return 1.235 * COIN;
    if (nHeight > 500000)	return 6.650 * COIN;
    if (nHeight > 475000)	return 6.365 * COIN;
	if (nHeight > 450000)	return 6.080 * COIN;
    if (nHeight > 425000)	return 5.795 * COIN;
    if (nHeight > 400000)	return 5.510 * COIN;
    if (nHeight > 375000)	return 5.225 * COIN;
    if (nHeight > 350000)	return 4.940 * COIN;
    if (nHeight > 325000)	return 4.655 * COIN;
    if (nHeight > 300000)	return 4.370 * COIN;
    if (nHeight > 275000)	return 4.085 * COIN;
    if (nHeight > 250000)	return 3.800 * COIN;
    if (nHeight > 225000)	return 3.515 * COIN;
    if (nHeight > 200000)	return 3.230 * COIN;
    if (nHeight > 175000)	return 2.945 * COIN;
    if (nHeight > 150000)	return 2.660 * COIN;
    if (nHeight > 125000)	return 2.375 * COIN;
    if (nHeight > 100000)	return 2.090 * COIN;
    if (nHeight > 75000)	return 1.805 * COIN;
    if (nHeight > 50000)	return 1.520 * COIN;
    if (nHeight > 20000)	return 1.235 * COIN;
    if (nHeight > 300)		return 0.950 * COIN;
...
bool CMasternodeBroadcast::CheckInputsAndAdd(int& nDoS)
{
    ...
    // should be at least not earlier than block when 1000 XLYN tx got MASTERNODE_MIN_CONFIRMATIONS
    uint256 hashBlock = UINT256_ZERO;
    CTransaction tx2;
    GetTransaction(vin.prevout.hash, tx2, hashBlock, true);
    BlockMap::iterator mi = mapBlockIndex.find(hashBlock);
    if (mi != mapBlockIndex.end() && (*mi).second) {
        CBlockIndex* pMNIndex = (*mi).second;                                                        // block for 1000 XLYN tx -> 1 confirmation
