Contributing to LYNTHEX Core
============================

The LYNTHEX Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/lynthex-project/lynthex/blob/master/doc/translation_process.md)
...
The following applies to code changes to the LYNTHEX Core project, and is not to be
confused with overall LYNTHEX Network Protocol consensus changes.

Whether a pull request is merged into LYNTHEX Core rests with the project merge
...
Patches that change LYNTHEX consensus rules are considerably more involved than
...
Where a patchset proposes to change the LYNTHEX consensus, it must have been
...
The project leader is the release manager for each LYNTHEX Core release.
