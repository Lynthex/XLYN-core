...
RESOURCES += src/qt/lynthex.qrc src/qt/lynthex_locale.qrc

TRANSLATIONS += src/qt/locale/lynthex_bg.ts \
                src/qt/locale/lynthex_de.ts \
                src/qt/locale/lynthex_en.ts \
                src/qt/locale/lynthex_es.ts \
                src/qt/locale/lynthex_fi.ts \
                src/qt/locale/lynthex_fr.ts \
                src/qt/locale/lynthex_it.ts \
                src/qt/locale/lynthex_ja.ts \
                src/qt/locale/lynthex_pl.ts \
                src/qt/locale/lynthex_pt.ts \
                src/qt/locale/lynthex_ru.ts \
                src/qt/locale/lynthex_sk.ts \
                src/qt/locale/lynthex_sv.ts \
                src/qt/locale/lynthex_vi.ts \
                src/qt/locale/lynthex_zh_CN.ts \
                src/qt/locale/lynthex_zh_TW.ts
