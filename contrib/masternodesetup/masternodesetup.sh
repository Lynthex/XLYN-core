...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='lynthex.conf'
CONFIGFOLDER='/root/.lynthex'
COIN_DAEMON='lynthexd'
COIN_CLI='lynthex-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ=`curl -s https://api.github.com/repos/lynthex/XLYN/releases/latest | grep "browser_download_url.*Linux\\.zip" | cut -d : -f 2,3 | tr -d \" | xargs`
