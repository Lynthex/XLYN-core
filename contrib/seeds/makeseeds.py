...
def main():
    ...
    # Filter out hosts with multiple lynthex ports, these are likely abusive
    ips = filtermultiport(ips)
    print('%s Filter out hosts with multiple lynthex ports' % (ip_stats(ips)), file=sys.stderr)
