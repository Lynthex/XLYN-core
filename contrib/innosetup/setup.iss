...
#define MyAppName "LYNTHEX Core"
#define MyAppPublisher "2022 LYNTHEX Core Developers"
#define MyAppURL "https://lynthex.net"
#define MyAppExeName "lynthex-qt.exe"
#define MyAppExtraData "https://explorer.lynthex.net/bootstraps/XLYN/bootstrap.zip"
...
OutputDir=.\output
OutputBaseFilename=LYNTHEXSetup
...
[Files]
Source: ".\package\lynthex-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\LYNTHEX\LYNTHEX-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\LYNTHEX\LYNTHEX-Qt,strDataDir|{userappdata}\LYNTHEX\}');
  Result := True;
end;
