...
This document provides guidelines for internationalization of the LYNTHEX Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        <source>%n active connection(s) to LYNTHEX network</source>
        <translation>
            <numerusform>%n active connection to LYNTHEX network</numerusform>
            <numerusform>%n active connections to LYNTHEX network</numerusform>
        </translation>
    </message>
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `lynthex_en.ts` remains unchanged.
