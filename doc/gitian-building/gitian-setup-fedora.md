...
The build script we'll be using is contained in the LYNTHEX github repository ([contrib/gitian-build.py](https://github.com/lynthex-project/lynthex/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the LYNTHEX repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/LYNTHEX-Project/LYNTHEX/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, lynthex-detached-sigs, and lynthex GitHub repos.
