...
The script [extract-osx-sdk.sh](https://github.com/lynthex-project/lynthex/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
lynthex/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/lynthex-project/lynthex/blob/master/doc/README_osx.md) for troubleshooting tips.
